    ...
    public static IEndpointRouteBuilder MapInvitations(this IEndpointRouteBuilder app)
    {
        app.MapPost("/v1/teachers/classes/{classId:guid}/invite",
                   ...
                   CancellationToken ct) =>
            {
                ...
                var baseUrl = $"{httpAccessor.HttpContext!.Request.Scheme}://{httpAccessor.HttpContext.Request.Host}";
        ...
        app.MapPost("/v1/invitations/accept",
                   ...
                   CancellationToken ct) =>
            {
                ...
                if (payload is null) return Results.BadRequest(new ProblemDetails
                {
                ...
                if (klass is null) return Results.NotFound(new ProblemDetails
                {
